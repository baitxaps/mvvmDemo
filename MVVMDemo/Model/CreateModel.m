...
- (void)createHeaderFile {
    ...
    // .h 文件头部信息
    NSString *head = \
    [NSString stringWithFormat:@"//\n//  %@.h\n//\n//  http://blog.csdn.net/baitxaps/\n//   https://github.com/baitxaps\n//\n//  Copyright (c) hairongchen All rights reserved.\n//\n\n\n#import <Foundation/Foundation.h>\n\n\n@interface %@ : NSObject\n\n\n", self.modelName, self.modelName];
...
- (void)createContentFile {
    ...
    // .m 文件头部信息
    NSString *head = \
    [NSString stringWithFormat:@"//\n//  %@.m\n//\n//  http://blog.csdn.net/baitxaps/\n//  https://github.com/baitxaps\n//\n//  Copyright (c) Hairong.chen  All rights reserved.\n//\n\n\n#import \"%@.h\"\n\n\n@implementation %@\n\n\n", self.modelName, self.modelName, self.modelName];
